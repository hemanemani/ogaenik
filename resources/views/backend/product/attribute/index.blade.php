						...
						@foreach($attributes as $key => $attribute)
							<tr>
								...
								<td class="text-right">
									...
									<a href="#" class="btn btn-soft-secondary btn-icon btn-circle btn-sm temporary-delete" data-href="{{route('attributes.temdestroy', $attribute->id)}}" title="{{ translate('Delete') }}">
                              			<i class="las la-trash"></i>
                           			</a>
								</td>
							</tr>
