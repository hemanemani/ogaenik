    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="form-group row">
                    <label class="col-md-3 col-form-label">{{translate('Specification')}}</label>
                    <div class="col-md-9">
                        <input type="text" placeholder="{{translate('Specification')}}" id="specification" name="specification" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select name="digital" required class="form-control aiz-selectpicker mb-2 mb-md-0">
							...
							<option value="2">{{translate('Gift')}}</option>
							<option value="3">{{translate('Settings')}}</option>
                        </select>
                    </div>
                </div>
                <div class="form-group row">
