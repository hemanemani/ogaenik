                ...
                <tr>
                    ...
                    <td>
                        <div class="input-group">
                            <input type="number" class="form-control" id="discount_{{ $category->id }}" step="0.01"
                                value="0" min="0" placeholder="{{translate('Discount')}}"
                    ...
                    <td>
                        <input type="text" class="form-control aiz-date-range rounded-2"
                            id="date_range_{{ $category->id }}" placeholder="{{translate('Select Date')}}"
            ...
            function(data) {
                if (data == 1) {
                    AIZ.plugins.notify('success', '{{ translate('
                        Category Wise Product Discount Set Successfully ') }}');
                }
                location.reload();
            }).fail(function() {
            AIZ.plugins.notify('danger', '{{ translate('
