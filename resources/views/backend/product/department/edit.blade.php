...
<div class="col-lg-8 mx-auto">
    <div class="card">
        <div class="card-body p-0">
            ...
            <form class="p-4" action="{{ route('departments.update', $brand->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    <label class="col-md-3 col-form-label" for="signinSrEmail">Icon <small>({{ translate('100x100') }})</small></label>
                    <div class="col-md-9">
                        <div class="input-group" data-toggle="aizuploader" data-type="image">
                            <div class="input-group-prepend">
                                <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                            ...
                            <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                            <input type="hidden" name="icon" value="{{$brand->icon}}" class="selected-files">
                        </div>
                        <div class="file-preview box sm">
                        </div>
                    </div>
                 ...
                 <div class="form-group row">
                    <label class="col-sm-3 col-from-label">Display Title</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="display_title" value="{{ $brand->display_title }}" placeholder="Display Title">
                    </div>
                </div>
                <div class="form-group row">
