...
<div class="col-md-10 mx-auto">
	<form class="form form-horizontal mar-top" action="{{route('giftproducts.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
		@csrf
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group row">
					...
					<div class="col-md-8">
						<textarea class="aiz-text-editor" name="manufacturer"></textarea>
					</div>
				</div>
			</div>
		</div>
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group row">
					<label class="col-md-3 col-from-label">{{translate('disclaimer')}}</label>
					<div class="col-md-8">
						<textarea class="aiz-text-editor" name="disclaimer"></textarea>
					</div>
				</div>
			</div>
		</div>
