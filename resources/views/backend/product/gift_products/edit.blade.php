...
<div class="col-lg-8 mx-auto">
	<form class="form form-horizontal mar-top" action="{{route('giftproducts.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
		...
		<div class="card">
			<div class="card-header">
				<h5 class="mb-0 h6">{{translate('Product Manufacturer')}}</h5>
			</div>
			<div class="card-body">
				<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Manufacturer')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-9">
                        <textarea class="aiz-text-editor" name="manufacturer">{{ $product->manufacturer }}</textarea>
                    </div>
                </div>
			</div>
		</div>
		...
		<div class="card">
			<div class="card-header">
				<h5 class="mb-0 h6">{{translate('Product Disclaimer')}}</h5>
			</div>
			<div class="card-body">
				<div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Disclaimer')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                    <div class="col-lg-9">
                        <textarea class="aiz-text-editor" name="disclaimer">{{ $product->disclaimer }}</textarea>
                    </div>
                </div>
			</div>
		</div>
