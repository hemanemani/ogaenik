<div class="aiz-user-sidenav-wrap pt-4 position-relative z-1 shadow-sm bg-white">
    ...
    <div class="aiz-user-sidenav rounded overflow-hidden  c-scrollbar-light">
        <div class="px-4 text-center mb-4">
            ...
            @if(Auth::user()->user_type == 'customer')
                <h4 class="h6 fw-600">{{ Auth::user()->name }} {{ Auth::user()->middlename }} {{ Auth::user()->lastname }}</h4>
            @else
                <h4 class="h6 fw-600">{{ Auth::user()->name }} {{ Auth::user()->middlename }} {{ Auth::user()->lastname }}
                    <span class="ml-2">
            ...
            <ul class="aiz-side-nav-list" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('purchase_history.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['purchase_history.index'])}}">
                        ...
                        <span class="aiz-side-nav-text">{{ translate('Order History') }}</span>
                        @if($delivery_viewed > 0 || $payment_status_viewed > 0)@endif
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('support_ticket.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['support_ticket.index'])}}">
                        ...
                        <span class="aiz-side-nav-text">{{translate('Report an Issue')}}</span>
